...
<body>
                    ...
                    <div class="search-form ml-auto">
                        <div class="form-w3layouts-grid">
                            <form action="ProductSearch" method="get" class="newsletter">
                                <input class="search" type="search" name="tosearch" placeholder="Search here..." required="">
    ...
    <section class="banner-bottom py-5">
        <div class="container py-5">
            ...
            <% // Creating ArrayList elements to get the respective mysql table data that is being stored as ArrayList within ProductBean class
              ArrayList<String> name = pb.getNameData();
              ArrayList<String> image = pb.getThumbData();
              ArrayList<String> id = pb.getIdData();
              ArrayList<String> colour = pb.getImageColor();
              List<Integer> price = pb.getPriceData();
                       
              for(int i=0; i<pb.getProductCount(); i++) {                       // FOR loop starts here, this runs till the size of ArrayList i.e., till products stored
                  System.out.println("Current Colour: "+colour.get(i));     // For verifing within console
                  System.out.println("Searched Colour: "+pb.getProductColour());
                if(colour.get(i).equals(pb.getProductColour())) {                   // IF condition starts here, Condition: if the colour searched matches the colour data within ArrayList then true
                        ...
                        out.print("<div class='item-info-product'>");
                           ...
                           out.print("<div class='product_price'>");
                               out.print("<div class='grid-price'>");
                                   out.print("<span class='money'>₹</span><span class='money' id='proPrice'>"+price.get(i)+"</span>");
                                   out.print("<input type='button' class='btn show-product' value='CLICK'/>");
                               out.print("</div>");
                           out.print("</div>");
